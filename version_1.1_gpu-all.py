...
VALIDATION_SIZE = 400
TEST_SIZE = 100
TEST_IMAGES_BEGIN = 12308
TEST_IMAGES_END =12466
...
def main(_):
    ...
    # file_path = "D:\\final\\useful_data_cut"
    # str = file_path + '/*.png'
    # xml_path = "D:\\final\\useful_data_cut\\useful_data_cut.xls"
    ...
    learning_rate = tf.train.exponential_decay(LEARNING_RATE, batch*BATCH_SIZE,3*train_size,0.96,staircase=True)
    ...
    with tf.Session() as sess:
        with tf.device("/gpu:0"):
            ...
            for step in range(int(NUM_EPOCHS * train_size) // BATCH_SIZE):
                ...
                # optim,logits = sess.run([optimizer,logits], feed_dict=feed_dict)
                # print(optim)
                # print(logits)
